...
Route::middleware(['permission:salary.menu'])->group(function () {
    ...
    Route::get('/pay-salary/create', [PaySalaryController::class, 'create'])->name('pay-salary.create');
    Route::resource('/pay-salary', PaySalaryController::class)->except(['show', 'edit', 'update', 'create']);
