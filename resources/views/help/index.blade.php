        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-wrap items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-gray-600">Comprehensive guide to SmartPOS Lite - Your Point of Sale Management System</p>
                </div>
            </div>

            <!-- Introduction Card -->
            <div class="bg-white rounded-lg shadow-md p-6 mb-8 border border-gray-200">
                <h3 class="text-xl font-semibold text-gray-800 mb-3">About SmartPOS Lite</h3>
                <p class="text-gray-700 leading-relaxed">
                    SmartPOS Lite is a robust, enterprise-grade Point of Sale (POS) management system designed for efficiency and ease of use.
